...
# Select individual items for correlation (example)
    item_cor_data <- combined_scores %>%
      select(ATT09 = perceived_difficulty, ELS01 = els_score, RS02 = env_attitude) #rename for clarity
 
    # Calculate correlation matrix for individual items
    item_correlation_matrix <- cor(item_cor_data, use = "pairwise.complete.obs")
    print("Item-Level Correlation Matrix:")
    print(item_correlation_matrix)
